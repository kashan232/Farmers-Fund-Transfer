                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            @if ($farmers->verification_status == '2')
                                                            <span class="badge text-bg-success">e By Land Officer</span>
                                                            @elseif ($farmers->verification_status == '0' && $farmers->declined_reason != '')
                                                        ...
                                                        <td>
                                                            <button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#exampleModalLive" data-id="{{ $farmers->id }}">Verify</button>
                                                        </td>
                                                        <td>
                                                            <div class="d-flex">
                                                                <a href="{{ route('view-do-farmers', ['id' => $farmers->id]) }}" class="btn btn-success btn-sm"><i class="fas fa-eye"></i></a>&nbsp;
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    @endforeach
