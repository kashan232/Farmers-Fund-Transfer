                                ...
                                <div class="step step-1">
                                    <div class="row mt-2">
                                        ...
                                        <div class="mb-6 col-md-6">
                                            ...
                                            <input type="text" name="district" id="district" class="form-control" value="{{ $all_land_farmer->district }}" readonly>
                                        </div>
                                        <div class="mb-6 col-md-6">
                                            <label class="form-label">Tehsil</label>
                                            <select name="tehsil" id="tehsil" class="form-control">
                                                @foreach(json_decode($tehsil) as $option)
                                                    <option value="{{ $option }}" {{ ($all_land_farmer->tehsil == $option) ? 'selected' : '' }}>
                                                        {{ $option }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="mb-3 col-md-6">
                                            ...
                                            <select name="uc" id="uc" class="form-control">
                                                <option  value="{{ $all_land_farmer->uc }}" selected >{{ $all_land_farmer->uc }}</option>
                                            </select>
                                        </div>
                                        @endif
                                        @endif
                                        ...
                                        <div class="mb-3 col-md-6">
                                            ...
                                            <select name="tappa" id="tappa" class="form-control">
                                                <option  value="{{ $all_land_farmer->tappa }}" selected >{{ $all_land_farmer->tappa }}</option>
                                            </select>
                                        </div>
                                        @else
                                        @endif
