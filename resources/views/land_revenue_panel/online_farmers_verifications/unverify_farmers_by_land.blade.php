    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="container">
                    <div class="row">
                        <form id="verifyfarmers" action="{{ route('verify-unverify-online-farmers') }}" method="POST">
                            @csrf
                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <div class="page-header-title">
                            <h2 class="mb-0">Online Unverify Farmers</h2>
                        </div>
                    </div>
                </div>
            </div>
                                    ...
                                    <div class="col-12 ">
                                        <div class="table-responsive">
                                            <table id="dom-jqry" class="table table-striped table-bordered nowrap dataTable" aria-describedby="dom-jqry_info" style="width: 100%;">
                                                ...
                                                <tbody>
                                                    @foreach($online_farmers as $online_farmer)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#exampleModalLive" data-id="{{ $online_farmer->id }}">Verify</button>
                                                        </td>
                                                    </tr>
                                                    @endforeach
                                                </tbody>
