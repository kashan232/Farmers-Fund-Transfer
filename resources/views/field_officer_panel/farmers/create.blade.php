                                ...
                                <div class="step step-1">
                                    <div class="row mt-2">
                                        ...
                                        <div class="mb-6 col-md-2 py-2">
                                            ...
                                            <input type="text" id="cnic_issue_date" name="cnic_issue_date" class="form-control" value="{{$data->cnic_issue_date ?? ''}}"   data-inputmask="'mask': '99-99-9999'" placeholder="DD-MM-YYYY" placeholder="DD-MM-YYYY"  >
                                        </div>
                                        <div class="mb-6 col-md-2 py-2 cnic_expiry_date_div">
                                            ...
                                            <input type="text" id="cnic_expiry_date" name="cnic_expiry_date" class="form-control" value="{{$data->cnic_expiry_date ?? ''}}"   data-inputmask="'mask': '99-99-9999'" placeholder="DD-MM-YYYY" placeholder="DD-MM-YYYY"  >
                                        </div>
                                        <div class="mb-6 col-md-6 py-2">
