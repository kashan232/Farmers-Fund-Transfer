          ...
          @if(isset($farmers))
            <div class="table-responsive">
                    ...
                    <form action="" class="d-flex col-4" style="margin-left: 4%;">
                        <input type="text" value="{{ $filters['search'] ?? 'Enter CNIC without hyphen/dashes' }}" class="form-control" style="margin-right: 2%" name="search" id="search"  placeholder="Enter CNIC without hyphen/dashes">
