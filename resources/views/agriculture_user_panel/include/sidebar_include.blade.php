        ...
        <div class="navbar-content">
            <ul class="pc-navbar">
                ...
                <li class="pc-item pc-hasmenu">
                    ...
                    <ul class="pc-submenu">
                        <li class="pc-item">
                            <a class="pc-link" href="{{ route('add-agriuser-farmers') }}">Add Farmers</a>
                        </li>
                        <li class="pc-item">
                            <a class="pc-link" href="{{ route('all-agriuser-farmers') }}">All Farmers</a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="pc-item pc-hasmenu">
                    <a href="{{ route('agriuser-farmers-reporting') }}" class="pc-link">
                        <span class="pc-micon">
                            <i class="fas fa-home"></i>
                        </span>
