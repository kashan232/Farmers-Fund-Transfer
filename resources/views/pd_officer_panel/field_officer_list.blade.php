                                                ...
                                                <tbody>
                                                    ...
                                                    {{-- {{ dd($user);}} --}}
                                                        <tr>
                                                            ...
                                                            <td style="text-align: center; font-size: 24px; font-weight: 700;;">{{ $user->farmers_count }} <br> <span style="font-size:12px"> Forwarded to AO = {{ $user->forwarded_to_ao }} </span> </td> <!-- This is from withCount('farmers') -->
                                                        </tr>
                                                    @endforeach
                                                </tbody>
                                            </table>
