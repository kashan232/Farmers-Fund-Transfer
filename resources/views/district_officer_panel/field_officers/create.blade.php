            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <form action="{{ route('store-field-officer') }}" method="post">
                                    @csrf
                                    ...
                                    <div class="row mt-2">
                                        <div class="mb-12 col-md-12">
                                            <label class="form-label">Select District</label>
                                                <input type="text" value="@if(isset($data)) {{ $data->district }} @else {{ $district }}  @endif" selected readonly name="district" id="district" class="form-control">
                                        </div>
                                    </div>
